/**
 * Task 7b fix round 1 — service-level coverage for `moveScene`'s no-write
 * no-op path.
 *
 ...
 * — that is the property the review flagged as most likely to drift, since
 * `_patchSong` unconditionally stamps `updatedAt` whenever it runs. A
